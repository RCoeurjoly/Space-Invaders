...
yosys -p "synth_ice40 -blif space_invaders_top.blif" space_invaders_top.v vga_controller.v sprite_drawer.v gameplay.v ship.v edge_detector_debouncer.v timer_1us.v player.v invaders.v clk_36MHz_generator.v bullet.v 2>&1 | tee file.log
